<h2><a href="https://www.geeksforgeeks.org/problems/evaluate-the-expression0307/1">Evaluate the expression</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a number n, find the value of below expression:<br>
