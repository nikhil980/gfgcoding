<h2><a href="https://www.geeksforgeeks.org/problems/for-loop-2-python/1?page=2&difficulty=Easy&sortBy=accuracy">For Loop 2- Python</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Welcome to the part 2 of For Loops in Python. In this question, we'll learn to print characters of a string at even indices. </span></p>
